        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.storeSecurity') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('phoneNumber') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="phone_number" id="input-number" class="form-control form-control-alternative{{ $errors->has('phoneNumber') ? ' is-invalid' : '' }}" placeholder="{{ __('phoneNumber') }}" value="{{ old('phoneNumber') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative mb-3">
                                       <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="security_profile_img" name="profile_img">
                                            <label class="custom-file-label" for="file">Profile</label>
                                        </div>
                                    </div>
                                </div>
